...
### exporting
write.table(model_fit_df, "4_geosse/geosse_model_fit_df.csv", sep=",", quote=F, row.names = T)
write.table(d_params, "4_geosse/d_params.csv", sep=",", quote=F, row.names = F)
write.table(sd_params, "4_geosse/sd_params.csv", sep=",", quote=F, row.names = F)
write.table(sxd_params, "4_geosse/sxd_params.csv", sep=",", quote=F, row.names = F)

########################### choosing the best ###########################

model_fit_df= read.table("4_geosse/geosse_model_fit_df.csv", sep=",", h = T)
...
### exporting
write.table(best_fit_models, "4_geosse/geosse_best_fit_models.csv", sep=",", quote=F, row.names = F)
